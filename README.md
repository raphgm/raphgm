...
### Projects
- [**GabraOs**](https://github.com/raphgm/GabraOs): The Open Standard for Autonomous Engineering — an operating system that continuously observes, tests, learns, secures, and optimizes software through autonomous AI agents.
